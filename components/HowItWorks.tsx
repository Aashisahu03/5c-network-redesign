    ...
    <div className="how-layout">
      <div className="how-steps">
        ...
        <div className="step-item reveal">
          ...
          <div className="step-content">
            <h3>QC agents validate the report</h3>
            <p>Specialized AI quality-control agents check every report for contradictions, completeness, and clinical accuracy before sign-off.</p>
          </div>
        </div>
        <div className="step-item reveal">
      ...
      <div className="how-visual reveal">
        <div className="workflow-diagram">
          <div className="workflow-node active">
            ...
            <span className="wf-time">0s</span>
          </div>
          <div className="workflow-connector"></div>
          <div className="workflow-node active">
            <span className="wf-icon">🤖</span>
            <div className="wf-text">
              <div className="wf-title">Bionic Vision Analysis</div>
              <div className="wf-sub">Detects, segments, measures</div>
            </div>
            <span className="wf-time">~15s</span>
          </div>
          <div className="workflow-connector"></div>
          ...
          <div className="workflow-node">
            <span className="wf-icon">✅</span>
            <div className="wf-text">
              <div className="wf-title">QC Agent Validates</div>
              <div className="wf-sub">Completeness &amp; accuracy</div>
            </div>
            <span className="wf-time">~2 min</span>
          </div>
          <div className="workflow-connector"></div>
          <div className="workflow-node active">
            <span className="wf-icon">📄</span>
